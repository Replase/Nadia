...
class MainViewController: UIViewController {
    ...
    @IBAction open func exitAll(){
        self.showViewController(viewController: UIViewController.self, storyboardId: "loginID")
    }
    ...
    override public func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = UIColor(red: 51.0, green: 55.0, blue: 82.0, alpha: 1.0)
        // Side Menu Gestures
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            self.showViewController(viewController: UIViewController.self, storyboardId: "PosID")
        case 2:
            self.showViewController(viewController: UIViewController.self, storyboardId: "ReglamentoID")
        case 3:
            self.showViewController(viewController: UIViewController.self, storyboardId: "MiEquipoID")
        case 4:
            self.showViewController(viewController: UIViewController.self, storyboardId: "PolID")
        default:
            break
        }
